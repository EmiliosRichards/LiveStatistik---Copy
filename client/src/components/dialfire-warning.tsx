...
interface DialfireWarningProps {
  show: boolean;
  onDismiss: () => void;
}

export function DialfireWarning({ show, onDismiss }: DialfireWarningProps) {
  if (!show) return null;
        ...
        <AlertDescription>
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <strong>Dialfire API Verbindung unterbrochen!</strong>
              <br />
              <span className="text-sm">Projektnamen werden möglicherweise als IDs angezeigt.</span>
              <div className="mt-2 flex gap-2">
                <Button
                  ...
                  data-testid="button-refresh-page-dialfire"
                >
            ...
            <Button
              ...
              onClick={onDismiss}
              data-testid="button-dismiss-dialfire-warning"
            >
              <X className="h-4 w-4" />
            </Button>
          </div>
